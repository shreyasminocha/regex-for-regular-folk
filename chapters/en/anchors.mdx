...
Let's revisit an example from [_Repetition_](repetition), and add the two anchors at the ends of the regex.
...
A word boundary is a _position_ between a [word character](character-escapes#word-character--w) and a non-word character.
